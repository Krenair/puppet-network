...
define network::route (
  Stdlib::Compat::Array $ipaddress,
  Stdlib::Compat::Array $netmask,
  Optional[Stdlib::Compat::Array] $gateway = undef,
  Optional[Stdlib::Compat::Array] $metric    = undef,
  Optional[Stdlib::Compat::Array] $mtu       = undef,
  Optional[Stdlib::Compat::Array] $scope     = undef,
  Optional[Stdlib::Compat::Array] $source    = undef,
  Optional[Stdlib::Compat::Array] $table     = undef,
  Optional[Stdlib::Compat::Array] $cidr      = undef,
  Optional[Stdlib::Compat::Array] $family    = [ 'inet4' ],
  $interface = $name,
  $ensure    = 'present'
) {
  if $cidr {
